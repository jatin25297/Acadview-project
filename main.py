...
#asking the user to cnoose from inbuilt statuses
...
#conditioning and removing the friend if length of the mnessage is abobe 100 letters
        if len(message) > 100:
